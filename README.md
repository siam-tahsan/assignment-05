Answer of Question---1️⃣
    var: Old way of declaring variables. It can be re-declared and updated. It is function-scoped.
    let: Modern way to declare variables. It can be updated but cannot be re-declared in the same scope.
